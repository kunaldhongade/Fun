      ...
      <div>
        <div
          className={clsx(
            Capacitor.getPlatform() === 'ios' &&
              'sticky top-0 z-[999] bg-dark pb-4 pt-[calc(2px+env(safe-area-inset-top))]',
        ...
        >
          ...
          <div className='relative -top-8 w-full'>
            <div className='h3 mx-auto w-9/12 rounded-full bg-gradient-primary px-2.5 py-3 text-black'>
              <div className='flex justify-center gap-1'>
                ...
                <span className='text-[10px]'>{NFTInfo && 'FTO'}</span>
              </div>
            </div>
