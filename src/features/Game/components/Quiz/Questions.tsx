  ...
  return (
    ...
    >
      ...
      <QuizCard
        title='Lebron James'
        image={
          typeof preQuestions.categoryImage === 'string' ? (
            <img src={preQuestions.categoryImage} alt='Category' />
          ) : React.isValidElement(preQuestions.categoryImage) ? (
            preQuestions.categoryImage
          ) : (
            <div />
          )
        }
